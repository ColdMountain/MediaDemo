...
- (void)mainSpeex{
    ...
    NSString *speexPath = [NSString stringWithFormat:@"%@/record2_noise.pcm",documentsDirectory];
    
    NSString *paths = [[NSBundle mainBundle] pathForResource:@"record2_pcm" ofType:@"pcm"];
